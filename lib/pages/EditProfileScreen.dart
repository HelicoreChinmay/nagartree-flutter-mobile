...
import 'package:flutter_nagartree/pages/AddFamilyPageScreen.dart';
import 'package:flutter_nagartree/user_edit_profile_model.dart';
            ...
            Column(
              children: <Widget>[
                ...
                /* Padding(
                  ...
                  child: CircleAvatar(
                    radius: 60.0,
                    backgroundImage: ExactAssetImage(Images.ImgUserProfile),
                  ),
                ), */
                /* inside
                              ...
                              : Padding(
                                  ...
                                  child: TextButton(
                                      ...
                                      editProfileBloodGroupValue; */
                                        ...
                                        /* if (base64Image == null && userEditProfileImage1 == "") {
                                          print("base64Image = $base64Image");
                                          print("base64Image is null");
                                          profileImage = "";
                                        } */
